    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        <div className="text-center bg-amber-50 dark:bg-amber-900/30 p-6 rounded-lg max-w-md">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">There are no quiz questions available for this course yet.</p>
          <Button onClick={handleBackToCourse}>Return to Course</Button>
        </div>
      </div>
    );
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Quiz Results</h1>
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Quiz</h1>
      </div>
      ...
      {/* Feedback Message */}
      {correctAns !== null && (
        <div className={`p-4 rounded-lg mb-6 ${correctAns ? 'bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800' : 'bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800'}`}>
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className={`mt-2 text-sm ${correctAns ? 'text-green-700 dark:text-green-300' : 'text-red-700 dark:text-red-300'}`}>
                {correctAns ? (
