...
function Flashcards() {
    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        <div className="text-center bg-amber-50 p-6 rounded-lg max-w-md">
          ...
          <p className="text-gray-700 mb-4">There are no flashcards available for this course yet.</p>
          <Button onClick={handleBackToCourse}>Return to Course</Button>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="relative bg-gradient-to-b from-blue-50 to-white rounded-xl p-8 shadow-md">
